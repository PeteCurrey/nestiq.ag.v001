...
// Dynamically import the map with SSR disabled — mapbox-gl is browser-only
  ...
  () => import("@/components/search/SearchMap").then((m) => m.SearchMap),
  {
    ...
    loading: () => (
      <div className="w-full h-full bg-obsidian flex items-center justify-center">
        <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-silk/40 animate-pulse">
          Loading Map…
        </span>
      </div>
    ),
