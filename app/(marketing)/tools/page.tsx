...
const tools = [
  { icon: PoundSterling, title: "Property Value Estimate", desc: "Get an indicative algorithm-based valuation for any UK residential property.", slug: "#" },
  { icon: Percent, title: "Mortgage Affordability", desc: "Calculate how much you could borrow based on your income and deposit.", slug: "#" },
  { icon: Home, title: "Rent Affordability", desc: "Understand your comfortable monthly rental limit based on your salary.", slug: "#" },
  { icon: Calculator, title: "Moving Cost Calculator", desc: "Estimate the total cost of moving, including solicitors, surveys, and removals.", slug: "#" },
  { icon: Activity, title: "Stamp Duty Calculator", desc: "Calculate your exact SDLT liability based on the latest government thresholds.", slug: "#" },
  { icon: Target, title: "Rental Yield Calculator", desc: "Instantly calculate gross and net rental yields for investment properties.", slug: "#" },
  { icon: Compass, title: "Area Comparison Tool", desc: "Compare two postcodes side-by-side on price, safety, and amenities.", slug: "#" },
  { icon: ClipboardList, title: "Offer Readiness Checklist", desc: "Ensure you have everything prepared before submitting an offer on a property.", slug: "#" }
];
    ...
    <div className="bg-silk min-h-screen">
      ...
      <section className="max-w-[1400px] mx-auto px-6 md:px-12 py-24">
         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {tools.map((tool, i) => (
              <div key={i} className="bg-white border border-border/40 p-10 hover:border-emerald/40 transition-colors group cursor-pointer">
