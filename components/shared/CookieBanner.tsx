  ...
  return (
    <div className="fixed bottom-8 left-8 right-8 md:left-auto md:w-[400px] z-[100] bg-obsidian text-silk p-8 border border-white/10 shadow-2xl animate-in slide-in-from-bottom-10 duration-700">
      <div className="flex items-start gap-4">
        <Cookie className="w-6 h-6 text-emerald flex-shrink-0" />
        <div>
          ...
          <div className="flex gap-4">
            <Button onClick={accept} className="bg-silk text-obsidian hover:bg-emerald hover:text-silk border-none flex-1 text-[10px] font-bold uppercase tracking-widest h-10">
              Accept All
            </Button>
